...
func NewRobot(setting robot.RobotConfig) *MidasSlotRobot {
...
func (t *MidasSlotRobot) GoCheckCommand(response *utils.RespBase) int {
...
func (t *MidasSlotRobot) CheckGoInGame(response *utils.RespBase) {
...
func (t *MidasSlotRobot) CheckSlotAction(response *utils.RespBase) {
	t.ContinueSpin()
}

func (t *MidasSlotRobot) ContinueSpin() {
...
func (t *MidasSlotRobot) SendMessage(data interface{}) {
