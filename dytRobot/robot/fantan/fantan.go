...
type FantanRobot struct {
	*robot.BaseBetRobot
}

var areaRate = []float64{3.85, 3.85, 3.85, 3.85, 1.95, 1.95, 1.95, 1.95, 1.95, 1.95}

func NewRobot(setting robot.RobotConfig) *FantanRobot {
