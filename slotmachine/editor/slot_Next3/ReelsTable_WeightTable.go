...
var (
	ngReelStrips = ReelStrips{
		...
		{21, 15, 5, 5, 11, 1, 12, 14, 31, 12, 13, 2, 2, 14, 11, 3, 31, 11, 15, 12, 4, 4, 15, 21, 13, 3, 14, 31, 12, 2, 12, 4, 13, 12, 1, 15, 13, 4, 15, 14, 11, 3, 13, 15, 21, 14, 12, 4, 11, 14, 13, 31, 13, 14, 5, 5, 15, 12, 3, 3, 11, 15, 13, 11, 5, 15, 31, 2, 2, 11, 12, 14, 13},
		...
		{21, 4, 31, 11, 13, 1, 14, 15, 12, 3, 15, 5, 13, 15, 14, 5, 15, 14, 31, 12, 11, 21, 13, 3, 11, 13, 4, 12, 15, 11, 11, 14, 2, 13, 4, 12, 1, 14, 3, 3, 11, 31, 12, 3, 5, 4, 14, 21, 13, 15, 2, 12, 13, 11, 31, 15, 15, 12, 4, 4, 11, 15, 2, 5, 5, 14, 31, 14, 12, 2, 2, 11, 13},
	}
...
var (
	...
	// 97
	WWMultiWeightTable_R3_ng_97 = []int{10, 70, 50, 30, 15, 8, 5} //{0, 0, 0, 1, 0, 0, 0} //
	WWMultiWeightTable_R4_ng_97 = []int{5, 80, 40, 25, 20, 8, 5}  //{0, 0, 1, 0, 0, 0, 0} //
	...
	// 98
	WWMultiWeightTable_R3_ng_98 = []int{10, 60, 50, 40, 15, 8, 5} //{0, 0, 0, 1, 0, 0, 0} //
	WWMultiWeightTable_R4_ng_98 = []int{5, 40, 40, 30, 15, 8, 5}  //{0, 0, 1, 0, 0, 0, 0} //
...
var (
	...
	WWMultiWeightTable_R3_fg = []int{10, 70, 200, 200, 80, 40, 10} //{0, 0, 0, 1, 0, 0, 0} //
	WWMultiWeightTable_R4_fg = []int{50, 60, 200, 200, 80, 30, 10} //{0, 0, 1, 0, 0, 0, 0} //
